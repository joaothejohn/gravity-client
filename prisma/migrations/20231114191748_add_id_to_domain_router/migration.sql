/*
  ...
  - The required column `id` was added to the `DomainRouter` table with a prisma-level default value. This is not possible if the table is not empty. Please add this column as optional, then populate it before making it required.
...
ADD CONSTRAINT "DomainRouter_pkey" PRIMARY KEY ("id");
